...
**Приклад результату:**
<img width="834" height="889" alt="image" src="https://github.com/user-attachments/assets/1e660754-64bc-4f98-a53d-0245e6fd2e94" />

<img width="733" height="893" alt="image" src="https://github.com/user-attachments/assets/ce4db598-06f7-4888-a6cf-ada19ef7124f" />

<img width="817" height="809" alt="image" src="https://github.com/user-attachments/assets/b02e6588-085c-4061-a18b-6f62430832f4" />
...
<img width="1119" height="834" alt="image" src="https://github.com/user-attachments/assets/39993386-e07e-400e-87c7-b36ec52f3d11" />
...
У ході виконання контрольної роботи було спроектовано реляційну БД з 6 таблицями: `Client`, `Tables`, `MenuItem`, `Reservation`, `Order`, `OrderItem`. Визначено зв'язки між сутностями через зовнішні ключі (`FOREIGN KEY`). Було реалізовано OLTP-запити для повсякденних операцій (INSERT, UPDATE, DELETE, SELECT), також реалізовано OLAP-запити для аналітики: денний дохід, популярність страв, середній чек за часом доби, рейтинг клієнтів за витратами з використанням CTE
